 ...
 * distribution.
 */
$fileDir = realpath(dirname(dirname(dirname(__FILE__))));
$testDir = $fileDir . '/XenPlus/tests';
$xpDir = $fileDir . '/XenPlus/library';
...
if (is_readable($testDir . DIRECTORY_SEPARATOR . 'TestConfiguration.php')) {
    ...
    require_once $testDir . DIRECTORY_SEPARATOR . 'TestConfiguration.php.dist';
}
 ...
 */
unset($fileDir, $testDir, $xpDir, $path);
