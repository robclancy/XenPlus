 ...
 */
interface XenPlus_Listener_ContainerAdminParams
{
	/**
	 * Called while preparing the container template of admin/back-end pages (PAGE_CONTAINER). You should use this to fetch any data you need for the container.
	 * 
